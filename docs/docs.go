...
const docTemplate = `{
    ...
    "definitions": {
        ...
        "model.DaoVote": {
            ...
            "properties": {
                "choice": {
                    "$ref": "#/definitions/model.VoteChoice"
                },
                "created_at": {
                    "type": "string"
                },
        ...
        "model.DaoVoteOption": {
            ...
            "properties": {
                ...
                "type": {
                    "$ref": "#/definitions/model.ProposalVotingType"
                },
                "updated_at": {
                    "type": "string"
                }
        ...
        "model.GuildConfigDaoProposal": {
            ...
            "properties": {
                ...
                "authority": {
                    "$ref": "#/definitions/model.ProposalAuthorityType"
                },
                "chain_id": {
                    "type": "integer"
                },
        ...
        "model.Quest": {
            ...
            "properties": {
                "action": {
                    "$ref": "#/definitions/model.QuestAction"
                },
                "frequency": {
                    "type": "integer"
                },
                ...
                "routine": {
                    "$ref": "#/definitions/model.QuestRoutine"
                },
                "title": {
                    "type": "string"
                }
        ...
        "model.TokenSupportRequestStatus": {
            "type": "string",
            "enum": [
                "approved",
                "rejected",
        ...
        "model.UserTokenSupportRequest": {
            ...
            "properties": {
                ...
                "status": {
                    "$ref": "#/definitions/model.TokenSupportRequestStatus"
                },
                "symbol": {
                    "type": "string"
                },
        ...
        "model.UserWalletWatchlistItem": {
            ...
            "properties": {
                ...
                "chain_type": {
                    "$ref": "#/definitions/model.ChainType"
                },
                "created_at": {
                    "type": "string"
                },
                ...
                "type": {
                    "$ref": "#/definitions/model.TrackingType"
                },
                "user_id": {
                    "type": "string"
                }
        ...
        "request.AddTokenPriceAlertRequest": {
            ...
            "properties": {
                "alert_type": {
                    ...
                    "allOf": [
                        {
                            "$ref": "#/definitions/model.AlertType"
                        }
                    ]
                },
                "frequency": {
                    ...
                    "allOf": [
                        {
                            "$ref": "#/definitions/model.AlertFrequency"
                        }
                    ]
                },
                "price_by_percent": {
