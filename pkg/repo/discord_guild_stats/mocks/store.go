...
// Source: ./pkg/repo/discord_guild_stats/store.go

// Package mock_discord_guild_stats is a generated GoMock package.
package mock_discord_guild_stats
...
func (m *MockStore) GetByGuildID(guildID string) (*model.DiscordGuildStat, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetByGuildID", guildID)
	ret0, _ := ret[0].(*model.DiscordGuildStat)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockStore) UpsertOne(streak model.DiscordGuildStat) error {
	m.ctrl.T.Helper()
