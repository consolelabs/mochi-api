...
import (
	...
	user_token_watchlist_item "github.com/defipod/mochi/pkg/repo/user_token_watchlist_item"
...
func (m *MockStore) List(q user_token_watchlist_item.UserWatchlistQuery) ([]model.UserTokenWatchlistItem, int64, error) {
	m.ctrl.T.Helper()
...
func (m *MockStore) Count(arg0 user_token_watchlist_item.CountQuery) (int64, error) {
	m.ctrl.T.Helper()
