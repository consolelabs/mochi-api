...
type IHandler interface {
	...
	CreateNFTSalesTracker(c *gin.Context)
	GetDetailNftCollection(c *gin.Context)
	GetAllNFTSalesTracker(c *gin.Context)
	DeleteNFTSalesTracker(c *gin.Context)
	...
	AddNftWatchlist(c *gin.Context)
	GetNftWatchlist(c *gin.Context)
	DeleteNftWatchlist(c *gin.Context)
