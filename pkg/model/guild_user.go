...
type GuildUser struct {
	...
	GuildID   int64          `json:"guild_id" gorm:"unique_index:idx_guild_user_guild_id_user_id"`
	UserID    int64          `json:"user_id" gorm:"uique_index:idx_guild_user_guild_id_user_id"`
